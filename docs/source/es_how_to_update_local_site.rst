...
Usa `Converter <converter.html>`_ para generar la *carpeta base* de los archivos SGML.

Usa `XML Converter <xml_converter.html>`_ para generar la *carpeta base* de los archivos XML.
