...
- Journal data: [http://www.ncbi.nlm.nih.gov/books/bv.fcgi?rid=helplinkout.section.files.Resource_File#files.Resource_File_Format]. 
    Sent once or every time the journal data was changed.

- Articles data: [http://www.ncbi.nlm.nih.gov/entrez/query/static/spec.html]. 
