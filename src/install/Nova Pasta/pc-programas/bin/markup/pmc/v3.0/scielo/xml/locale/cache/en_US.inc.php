<?php $localeData = array (
  ...
  'manager.setup.reviewQuestions.viewReviewForm' => 'View Review Form',
  ...
  'issue.dateiso' => 'Publication date YYYY-MM-DD',
  'issue.vol' => 'Vol',
  'issue.no' => 'No',
  'issue.suppl' => 'Suppl',
  'issue.year' => 'Year',
  ...
  'submission.event.markup.markupResponsibleAssigned' => 'Responsible for markup assigned to submission',
  'submission.event.markup.markupResponsibleUnassigned' => 'Responsible for markup unassigned from submission',
  'submission.event.markup.markupInitiated' => 'Markup assignment initiated',
  'submission.event.markup.markupRevision' => 'Responsible for markup revisions file updated',
  'submission.event.markup.markupInitialCompleted' => 'Initial markup completed',
  'submission.event.markup.markupFinalCompleted' => 'Final markup completed',
  'submission.event.markup.markupSetFile' => 'Markup file updated',
...
Setting up LOCKSS support for Open Journal Systems does not need to take place until after publishing is fully underway, at which point follow these two steps:',
  'manager.setup.lockssRegister' => 'Identify 6-10 libraries that will register and cache the journal. For example, turn to institutions where editors or Board members work and/or institutions already participating in LOCKSS. See <a href="http://lockss.stanford.edu/about/users.htm" target="_blank">participating libraries</a>. Use the prepared invitations for (i) <a href="{$pageUrl}/manager/email?template=LOCKSS_EXISTING_ARCHIVE" target="_blank">libraries participating in LOCKSS</a> or (ii) <a href="{$pageUrl}/manager/email?template=LOCKSS_NEW_ARCHIVE" target="_blank">libraries not yet participating in LOCKSS</a>.',
  'manager.setup.lockssEnable' => 'Enable LOCKSS to store and distribute journal content at participating libraries via a LOCKSS <a href="{$pageUrl}/gateway/lockss" target="_blank">Publisher Manifest</a> page. A LOCKSS license will appear in About the Journal under Archiving:',
  'manager.setup.lockssLicenses' => 'See <a href="http://lockss.stanford.edu/publishers/publishers.htm" target="_blank">other versions of a LOCKSS license</a>.',
...
<a href="http://pkp.sfu.ca/harvester/add.php" target="_blank">Click here</a> and enter <span class="highlight">{$siteUrl}</span> under <b>Site URL</b>, and <span class="highlight">{$oaiUrl}</span> under <b>Base URL for OAI Archive</b>.',
  ...
  'manager.setup.publicationFormatDescription' => 'Select the default format for identifying journal issues and/or volumes. The format can be overridden for individual issues.',
  ...
  'manager.setup.publicationFormatTitleDescription' => 'Note: While a title can be added to any issue, with this final option, the issue is identified by its title alone (if OJS is used, for example, for a set of edited volumes).',
...
Select a model for handling these aspects of the editorial process. (To designate a Managing Editor and Section Editors, go to Editors in Journal Management.)',
  ...
  'manager.setup.subscriptionDescription' => 'When Subscription Management is activated, the Journal Manager is able to set up the Subscription Types (with a fee structure) and to manage subscribers (under Subscriptions on the Journal Management page). Subscription Management also enables the Editor to designate an article or issue for free access, whether immediately or up to 24 months after publication.',
  ...
  'manager.languages.articleAltLanguages' => 'Authors should be asked to provide titles and abstracts in the other language(s), with the option of having this done by journal staff.',
  ...
  'manager.sections.identifyType' => 'In their metadata, identify items in this section as',
  'manager.sections.identifyTypeExamples' => '(For example, "Peer-reviewed Article", "Non-refereed Article", "Invited Article", etc.)',
  'manager.sections.abstractsDisabled' => 'Items published in this Section will not have abstracts.',
...
You may optionally provide the user with a reason for disabling their account.',
  ...
  'manager.subscriptions.selectSubscriber.desc' => 'Choose which user you wish to subscribe to the journal. Note that a journal\'s Managers, Editors, Section Editors, Layout Editors, Copyeditors, and Proofreaders are always free to browse the journal as if they were subscribers.',
  'manager.subscriptions.subscribe' => 'Subscribe',
...
Days refers to average period of time to complete a review.<br />
...
with a plus sign (+) indicating review-in-progress.',
  ...
  'editor.article.cannotRecord' => 'Submissions must be assigned to a section editor and an editor version must exist before the decision can be recorded. Further decisions cannot be recorded once a submission has been sent to copyediting.',
  ...
  'editor.article.designateDueDateDescription' => 'To change the due date for this Reviewer, enter another date or delete the date and enter the number of weeks until the review is due.',
  ...
  'editor.article.emailAuthorOnArchive' => 'Email author about the archiving of this submission?',
  'editor.article.restoreToQueue' => 'Restore to Active List',
  'editor.article.assignEditor' => 'Assign Section Editor',
...
The file can be viewed by clicking on the file name. A new or revised file can be uploaded, deleting the one that currently appears. If you have difficulties uploading the submission, contact <a href="mailto:{$supportEmail}">{$supportName}</a> by email or phone {$supportPhone} for assistance.',
  ...
  'submission.logType.markup' => 'Markup',
...
current password.<br /><br />Enter your email address below to reset your password. A confirmation will be sent to this email address.',
  ...
  'user.register.notAlreadyRegisteredOtherJournal' => '<a href="{$registerUrl}">Click here</a> if you are <b>not</b> already registered with this or another journal on this site.',
...
<li>By default only articles containing <i>all</i> terms in the query are returned (i.e., <b>AND</b> is implied)</li>
<li>Combine multiple words with <b>OR</b> to find articles containing either term; e.g., <i>education OR research</i></li>
<li>Use parentheses to create more complex queries; e.g., <i>archive ((journal OR conference) NOT theses)</i></li>
<li>Search for an exact phrase by putting it in quotes; e.g., <i>"open access publishing"</i></li>
<li>Exclude a word by prefixing it with <b>-</b> or <b>NOT</b>; e.g. <i>online -politics</i> or <i>online NOT politics</i></li>
<li>Use <b>*</b> in a term as a wildcard to match any sequence of characters; e.g., <i>soci* morality</i> would match documents containing "sociological" or "societal"</li>
</ul>',
  ...
  'about.aboutThisPublishingSystem' => 'About the SciELO/OJS Editorial and Publishing System',
  'about.people' => 'People',
  'about.policies' => 'Policies',
  'about.other' => 'Other',
  'about.aboutOJSJournal' => 'This journal uses Open Journal Systems customized for SciELO.',
  'about.aboutOJSSite' => 'This site uses Open Journal Systems customized for SciELO.',
  'help.help' => 'Help',
  ...
  'installer.installationInstructions' => '<h4>OJS / SciELO Version {$version}</h4>

<p>Thank you for downloading the Public Knowledge Project\'s <strong>Open Journal Systems</strong> with <strong>SciELO</strong> customizations. Before proceeding, please read the <a href="{$baseUrl}/docs/README">README</a> and <a href="{$baseUrl}/docs/README_SCIELO">README_SCIELO</a> files included with this software. For more information about the Public Knowledge Project and its software projects, please visit the <a href="http://pkp.sfu.ca/" target="_blank">PKP web site</a>. For more information about the SciELO Methodology, please visit the <a href="http://www.scielo.org/" target="_blank">SciELO.org site</a>. Send bug reports or technical support inquiries about Open Journal Systems to <a href="mailto:pkp-support@sfu.ca">pkp-support@sfu.ca</a> or <a href="mailto:scielo@bireme.br">scielo@bireme.br</a>, or visit PKP\'s online <a href="http://pkp.sfu.ca/bugzilla/" target="_blank">bug reporting system</a>.</p>
...
<p>Don\'t forget to set the "installed" setting in your config.inc.php configuration file back to <i>On</i>.</p>',
  ...
  'log.markup.initiate' => 'Markup on submission {$myJournal_articleId} has been commenced by {$markupResponsibleName}.',
  'log.markup.markupFileSet' => 'The default markup file has been chosen.',
  'log.markup.initialEditComplete' => '{$markupResponsibleName} has completed the initial markup of submission {$myJournal_articleId}.',
  'log.markup.markupResponsibleAssigned' => '{$markupResponsibleName} has been assigned to markup submission {$myJournal_articleId}.',
  'log.markup.finalEditComplete' => '{$markupResponsibleName} has completed the final markup of submission {$myJournal_articleId}.',
  'log.markup.markupResponsibleFile' => 'A markup version of the submission file has been uploaded.',
  'log.markup.authorFile' => 'A version of the submission file marked by the author has been uploaded.',
  ...
  'log.imported' => '{$userName} has imported article {$myJournal_articleId}.',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'rt.forThis' => 'For this {$identifyType}',
  ...
  'rt.thisJournal' => 'Find items in this journal',
