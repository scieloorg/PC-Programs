...
class PMCPackage:
    ...
    def convert_file(self, report, xml_filename, work_path, scielo_html_validation_report, scielo_html_preview, pmc_html_validation_report, pmc_html_preview, pmc_path, jpg_path):
        r = False
        ...
        if self.validator_scielo.validate(report, jpg_path, name.replace('.xml', '.local.xml')):
    ...
    def do_for_all(self, report, scielo_package_path, pmc_path, jpg_path, validation_path,  scielo_html_validation_report_ext = '.rep.html', scielo_html_preview_ext = '.xml.html', pmc_html_validation_report_ext = '.pmc.rep.html', pmc_html_preview_ext = '.pmc.xml.html'):        
        if not os.path.exists(pmc_path):
            os.makedirs(pmc_path)
        for filename in os.listdir(scielo_package_path):
            if filename.endswith('.xml'):
                ...
                self.convert_file(report, scielo_package_path + '/' + filename, validation_path, scielo_html_validation_report, scielo_html_preview, pmc_html_validation_report, pmc_html_preview, pmc_path, jpg_path)
            elif not filename.endswith('.jpg'):
                shutil.copyfile(scielo_package_path + '/' + filename, pmc_path+ '/' + filename)

    def do_for_one(self, report, xml_filename, pmc_package_path, jpg_path, validation_path, scielo_html_validation_report_ext = '.rep.html', scielo_html_preview_ext = '.xml.html', pmc_html_validation_report_ext = '.pmc.rep.html', pmc_html_preview_ext = '.pmc.xml.html'):       
        ...
        if os.path.isfile(xml_filename) and xml_filename.endswith('.xml'):
            ...
            for filename in files:
                if filename.endswith('.xml'):
                    ...
                    self.convert_file(report, scielo_package_path + '/' + filename, validation_path, scielo_html_validation_report, scielo_html_preview, pmc_html_validation_report, pmc_html_preview, pmc_package_path, jpg_path)
...
class XMLPacker:
    ...
    def generate_one_file(self, src_xml_path, src_paths_and_exts, src_img_path, scielo_package_path, report, acron, xml_filename, pmc_package_path, reports_path):    
        ...
        self.pmc_package.do_for_one(report, scielo_package_path + '/' + self.scielo_package.new_name + '.xml', pmc_package_path, scielo_package_path, reports_path)
    ...
    def generate_one_folder(self, src_xml_path, src_paths_and_exts, src_img_path, scielo_package_path, report, acron, pmc_package_path, reports_path):
        ...
        self.pmc_package.do_for_all(report, scielo_package_path, pmc_package_path, scielo_package_path, reports_path)


    def generate_validation_reports(self, report, scielo_package_path, pmc_package_path, reports_path, jpg_path):
        self.pmc_package.do_for_all(report, scielo_package_path, pmc_package_path, jpg_path, reports_path)
