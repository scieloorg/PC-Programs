...
if not exist ..\..\..\bin\xml\app_core\tools\xml_pubmed.py goto END
%MX% "seq=%SCI_LISTA% " lw=9999 "pft=if p(v1) then 'python ..\..\..\bin\xml\app_core\tools\xml_pubmed.py %Serial_Directory%\',v1,'\',v2,' ',v4,' ',v5/ fi" now> temp\xml_pubmed.bat
