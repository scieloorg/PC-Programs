...
from xml_tree.table_ent_and_char import TableEntAndChar

from markup_pmc.markup_pmc_files import MarkupPMC
...
if parameters.check_parameters(sys.argv):
    ...
    jar_path = jar_path.replace('core','xml_java/jar')
    ...
    pmc = MarkupPMC(JavaXMLTransformer(java_path, jar_saxon , jar_path),  XMLTree(TableEntAndChar(app_path + '/xml_tree/table_ent_char')), xsl_path)
