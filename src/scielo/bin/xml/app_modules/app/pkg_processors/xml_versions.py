...
XPM_FILES['scielo3.0']['relative_dtd_path'] = _PMC_PATH + '/v3.0/dtd/'
...
XPM_FILES['pmc3.0']['relative_dtd_path'] = _PMC_PATH + '/v3.0/dtd'
...
XPM_FILES['scielo1.0']['relative_dtd_path'] = _PMC_PATH + '/j1.0/dtd/jats1.0'
...
XPM_FILES['pmc1.0']['relative_dtd_path'] = _PMC_PATH + '/j1.0/dtd/jats1.0'
