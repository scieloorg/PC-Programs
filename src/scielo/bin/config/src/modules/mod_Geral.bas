...
'Public Const app.title+" - " = "SciELO Core Manager - "
Public Const ISSUE_FORM_CAPTION = "ISSUE Database - "
Public Const SECTION_FORM_CAPTION = "SECTION Database - "
Public Const TITLE_FORM_CAPTION = "TITLE Database - "
