...
Public Sub ViewIseqNo(sertitle As String, volid As String, supplvol As String, issueno As String, Supplno As String, IseqNo As String, idPart As String)
    ...
    q = Issue0.issueDAO.getIssuesMfn(volid, issueno, sertitle, Mfns)
